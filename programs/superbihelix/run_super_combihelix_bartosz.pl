...
for ($i = 1; $i <= $proc; $i++)
{
  ...
  if ($rot eq "rot"){print PBS "/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_combihelix_bartosz.pl $bgf $mfta $num1 $num2 $i $fin $ref $rot\n\n";}
  else {print PBS "/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_combihelix_bartosz.pl $bgf $mfta $num1 $num2 $i $fin $ref\n\n";}
