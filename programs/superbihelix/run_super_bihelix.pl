...
system ("/project/Biogroup/Software/GEnsemble/programs/superbihelix/fix_angles_file $bgf $mfta");
...
for ($i = 0; $i < 12; $i++)
{
  ...
  print PBS "/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_bihelix_pl.pl $bgf $mfta $tm1[$i] $tm2[$i] $nm $lst > \$SCRATCH/\${PBS_JOBNAME}.output\n\n";
