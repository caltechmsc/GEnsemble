...
def RunSetup(incldir, cppflags, ldflags, libdir):
      setup(name="SCREAM",
            version="1.0",
            author="Victor Kam",
            author_email="victor@wag.caltech.edu",
            description="wrapper class for SCREAM",
            #py_modules=["ModSCREAM", "Py_Scream_EE"],
            py_modules=['Py_Scream_EE'],
            ext_modules=[
#                  Extension("_ModSCREAM",
#                            ["ModSCREAM_wrap.cpp",
#                             ],
...
#                           ),
                  Extension("_Py_Scream_EE",
                            ["Py_Scream_EE_wrap.cpp",
                             ],
                            extra_compile_args=cppflags,
                            include_dirs=incldir,
                            libraries=libs,
