...
def main():
    ...
    #ff_file = '/ul/jaw/FF/PS330_mpsim.par'
    scream_delta_file = '/project/Biogroup/Software/SCREAM/lib/SCREAM_delta_par_files/SCREAM_delta_Total_Min.par'
    ...
    print >>SCREAM_PAR_FILE, '%25s %s' % ('EachAtomDeltaFile', '/project/Biogroup/Software/SCREAM/lib/SCREAM_delta_par_files/SCREAM_EachAtomDeltaFileStub.par')
    print >>SCREAM_PAR_FILE, '%25s %s' % ('PolarOptimizationExclusions', '/project/Biogroup/Software/SCREAM/lib/SCREAM_delta_par_files/SCREAM_PolarOptimizationExclusionsStub.par')
    ...
    run_line_str = '/ul/victor/SCREAM/SCREAM_v3.0/SCREAM/python/app/SCREAM.py' + ' ' + scream_par_filename + ' > ' + 'scream.out'
