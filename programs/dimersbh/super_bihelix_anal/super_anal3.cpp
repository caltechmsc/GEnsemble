...
main (int argc, char* argv[])
{
  ...
  int total;
  numb = numbx;
  total = (phi_num[5])*(thet_num[5])*(hpm_num[5])*(eta_num[5])*(phi_num[6])*(thet_num[6])*(hpm_num[6])*(eta_num[6])*(phi_num[3])*(thet_num[3])*(hpm_num[3])*(eta_num[3])*(phi_num[7])*(thet_num[7])*(hpm_num[7])*(eta_num[7]);
  if (total < numbx)
  {numb = total;}
  numb1 = numb - 1;
                   ...
                   for (int b5 = 0; b5 < thet_num[5]; b5++) {
                    for (int c5 = 0; c5 < hpm_num[5]; c5++) {
                     for (int d5 = 0; d5 < eta_num[5]; d5++) {
                      for (int a6 = 0; a6 < phi_num[6]; a6++) {
                       for (int b6 = 0; b6 < thet_num[6]; b6++) {
                        for (int c6 = 0; c6 < hpm_num[6]; c6++) {
                         for (int d6 = 0; d6 < eta_num[6]; d6++) {
                          for (int a7 = 0; a7 < phi_num[7]; a7++) {
                           for (int b7 = 0; b7 < thet_num[7]; b7++) {
                            for (int c7 = 0; c7 < hpm_num[7]; c7++) {
                             for (int d7 = 0; d7 < eta_num[7]; d7++) {
                               sprintf(struc,"H3 %.0f %.0f %.0f %.0f H5 %.0f %.0f %.0f %.0f H6 %.0f %.0f %.0f %.0f H7 %.0f %.0f %.0f %.0f",phi3[a3+1],thet3[b3+1],hpm3[c3+1],eta3[d3+1],phi5[a5+1],thet5[b5+1],hpm5[c5+1],eta5[d5+1],phi6[a6+1],thet6[b6+1],hpm6[c6+1],eta6[d6+1],phi7[a7+1],thet7[b7+1],hpm7[c7+1],eta7[d7+1]);
                               sprintf(struc2,"%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i",a3,b3,c3,d3,a5,b5,c5,d5,a6,b6,c6,d6,a7,b7,c7,d7);   
                               intr3 = (intr11[a3][b3][c3][d3][a5][b5][c5][d5][3][5]+intr11[a3][b3][c3][d3][a6][b6][c6][d6][3][6]+intr11[a3][b3][c3][d3][a7][b7][c7][d7][3][7])/3;
                               intr5 = (intr22[a3][b3][c3][d3][a5][b5][c5][d5][3][5]+intr11[a5][b5][c5][d5][a6][b6][c6][d6][5][6])/2;
                               intr6 = (intr22[a3][b3][c3][d3][a6][b6][c6][d6][3][6]+intr22[a5][b5][c5][d5][a6][b6][c6][d6][5][6]+intr11[a6][b6][c6][d6][a7][b7][c7][d7][6][7])/3;
                               intr7 = (intr22[a3][b3][c3][d3][a7][b7][c7][d7][3][7]+intr22[a6][b6][c6][d6][a7][b7][c7][d7][6][7])/2;
                               long double rnd = (rand() % 1000) + 1;
                               inter = (rnd/10000)+inter12[a3][b3][c3][d3][a5][b5][c5][d5][3][5]+inter12[a3][b3][c3][d3][a6][b6][c6][d6][3][6]+inter12[a3][b3][c3][d3][a7][b7][c7][d7][3][7]+inter12[a5][b5][c5][d5][a6][b6][c6][d6][5][6]+inter12[a6][b6][c6][d6][a7][b7][c7][d7][6][7];
                               tot = intr3+intr5+intr6+intr7+inter;
                               nointv = tot - interv12[a3][b3][c3][d3][a5][b5][c5][d5][3][5]-interv12[a3][b3][c3][d3][a6][b6][c6][d6][3][6]-interv12[a3][b3][c3][d3][a7][b7][c7][d7][3][7]-interv12[a5][b5][c5][d5][a6][b6][c6][d6][5][6]-interv12[a6][b6][c6][d6][a7][b7][c7][d7][6][7];
                               hbond = (rnd/10000)+interh12[a3][b3][c3][d3][a5][b5][c5][d5][3][5]+interh12[a3][b3][c3][d3][a6][b6][c6][d6][3][6]+interh12[a3][b3][c3][d3][a7][b7][c7][d7][3][7]+interh12[a5][b5][c5][d5][a6][b6][c6][d6][5][6]+interh12[a6][b6][c6][d6][a7][b7][c7][d7][6][7];
                               if (j<numb)
                               {
                                 tot_t[j] = tot;
                                 inter_i[j] = inter;
  ...
  sprintf(totout0x,"Total_Energy_3_temp");
