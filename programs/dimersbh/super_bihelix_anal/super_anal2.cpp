...
main (int argc, char* argv[])
{
  ...
  int total;
  numb = numbx;
  total = (phi_num[5])*(thet_num[5])*(hpm_num[5])*(eta_num[5])*(phi_num[2])*(thet_num[2])*(hpm_num[2])*(eta_num[2])*(phi_num[3])*(thet_num[3])*(hpm_num[3])*(eta_num[3])*(phi_num[4])*(thet_num[4])*(hpm_num[4])*(eta_num[4]);
  if (total < numbx)
  {numb = total;}
  numb1 = numb - 1;

  int j = 0;
  long double tot_t[20000],inter_i[20000],nointv_v[20000],hbond_h[20000];
           ...
           for (int b3 = 0; b3 < thet_num[3]; b3++) {
            for (int c3 = 0; c3 < hpm_num[3]; c3++) {
             for (int d3 = 0; d3 < eta_num[3]; d3++) {
              for (int a4 = 0; a4 < phi_num[4]; a4++) {
               for (int b4 = 0; b4 < thet_num[4]; b4++) {
                for (int c4 = 0; c4 < hpm_num[4]; c4++) {
                 for (int d4 = 0; d4 < eta_num[4]; d4++) {
                  for (int a5 = 0; a5 < phi_num[5]; a5++) {
                   for (int b5 = 0; b5 < thet_num[5]; b5++) {
                    for (int c5 = 0; c5 < hpm_num[5]; c5++) {
                     for (int d5 = 0; d5 < eta_num[5]; d5++) {
                               sprintf(struc,"H2 %.0f %.0f %.0f %.0f H3 %.0f %.0f %.0f %.0f H4 %.0f %.0f %.0f %.0f H5 %.0f %.0f %.0f %.0f",phi2[a2+1],thet2[b2+1],hpm2[c2+1],eta2[d2+1],phi3[a3+1],thet3[b3+1],hpm3[c3+1],eta3[d3+1],phi4[a4+1],thet4[b4+1],hpm4[c4+1],eta4[d4+1],phi5[a5+1],thet5[b5+1],hpm5[c5+1],eta5[d5+1]);
                               sprintf(struc2,"%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i",a2,b2,c2,d2,a3,b3,c3,d3,a4,b4,c4,d4,a5,b5,c5,d5);
                               intr2 = (intr11[a2][b2][c2][d2][a3][b3][c3][d3][2][3]+intr11[a2][b2][c2][d2][a4][b4][c4][d4][2][4])/2;
                               intr3 = (intr22[a2][b2][c2][d2][a3][b3][c3][d3][2][3]+intr11[a3][b3][c3][d3][a4][b4][c4][d4][3][4]+intr11[a3][b3][c3][d3][a5][b5][c5][d5][3][5])/3;
                               intr4 = (intr22[a2][b2][c2][d2][a4][b4][c4][d4][2][4]+intr22[a3][b3][c3][d3][a4][b4][c4][d4][3][4]+intr11[a4][b4][c4][d4][a5][b5][c5][d5][4][5])/3;
                               intr5 = (intr22[a3][b3][c3][d3][a5][b5][c5][d5][3][5]+intr22[a4][b4][c4][d4][a5][b5][c5][d5][4][5])/2;
                               long double rnd = (rand() % 1000) + 1;
                               inter = (rnd/10000)+inter12[a2][b2][c2][d2][a3][b3][c3][d3][2][3]+inter12[a2][b2][c2][d2][a4][b4][c4][d4][2][4]+inter12[a3][b3][c3][d3][a4][b4][c4][d4][3][4]+inter12[a3][b3][c3][d3][a5][b5][c5][d5][3][5]+inter12[a4][b4][c4][d4][a5][b5][c5][d5][4][5];
                               tot = intr2+intr3+intr4+intr5+inter;
                               nointv = tot - interv12[a2][b2][c2][d2][a3][b3][c3][d3][2][3]-interv12[a2][b2][c2][d2][a4][b4][c4][d4][2][4]-interv12[a3][b3][c3][d3][a4][b4][c4][d4][3][4]-interv12[a3][b3][c3][d3][a5][b5][c5][d5][3][5]-interv12[a4][b4][c4][d4][a5][b5][c5][d5][4][5];
                               hbond = (rnd/10000)+interh12[a2][b2][c2][d2][a3][b3][c3][d3][2][3]+interh12[a2][b2][c2][d2][a4][b4][c4][d4][2][4]+interh12[a3][b3][c3][d3][a4][b4][c4][d4][3][4]+interh12[a3][b3][c3][d3][a5][b5][c5][d5][3][5]+interh12[a4][b4][c4][d4][a5][b5][c5][d5][4][5];
                               if (j<numb)
                               {
                                 tot_t[j] = tot;
                                 inter_i[j] = inter;
  ...
  sprintf(totout0x,"Total_Energy_2_temp");
