...
if ($fin == 1)
{
  ...
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort_dev.pl -p $proc -b $bgf -m $mfta --sortrank 'NCti' --range '1-100' --ppn 4 --bio $bio -md $masterdir"); 
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort_dev.pl -p $proc -b $bgf -m $mfta --sortrank 'Cih'  --range  '1-25' --ppn 1 --bio $bio -md $masterdir");   
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort_dev.pl -p $proc -b $bgf -m $mfta --sortrank 'Ctl'  --range  '1-25' --ppn 1 --bio $bio -md $masterdir");   
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort_dev.pl -p $proc -b $bgf -m $mfta --sortrank 'Nih'  --range  '1-25' --ppn 1 --bio $bio -md $masterdir");   
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort_dev.pl -p $proc -b $bgf -m $mfta --sortrank 'Ntl'  --range  '1-25' --ppn 1 --bio $bio -md $masterdir");   
}
