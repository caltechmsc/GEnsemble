...
#    print $rmsd[0] . " " . $rmsdz . " " . $rmsdx. " ";
    ...
    my $bundle2 = &spe($finbgf);
    my ($interHelEng, $helixEng) = &getInterHel($finbgf,$bundle2,$type);
    my ($neutEng, $neutInterHel, $neutHelixEng);
    $neutEng = &neutralize($finbgf,$stripbgf);
    ($neutInterHel, $neutHelixEng) = &getInterHel("$stripbgf-neut.bgf",$neutEng,$type);
...
if ($fin == 1)
{
  ...
  if (not defined $name){
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankNCti '1-100' 4"); # if not running on bioscratch
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankCih '1-25' 1");   # if not running on bioscratch
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankCtl '1-25' 1");   # if not running on bioscratch
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankNih '1-25' 1");   # if not running on bioscratch
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankNtl '1-25' 1");   # if not running on bioscratch
  }
  else {
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankNCti '1-100' 1 $name $curdir"); 
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankCih '1-25' 1 $name $curdir");   
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankCtl '1-25' 1 $name $curdir");   
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankNih '1-25' 1 $name $curdir");   
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl $proc $bgf $mfta rankNtl '1-25' 1 $name $curdir");   
  }
}
