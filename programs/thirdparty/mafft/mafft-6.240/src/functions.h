...
extern int TreeDependentIteration( int locnjob, char name[M][B], int nlen[M], char **aseq, char **bseq, int ***topol, double **len, int alloclen, LocalHom **localhomtable );
...
extern float Falign_noudp( char  **seq1, char  **seq2, double *eff1, double *eff2, int    clus1, int    clus2, int alloclen, int *fftlog );
...
extern float L__align11_noalign( char **seq1, char **seq2, int alloclen, int *off1pt, int *off2pt, int saimatch );
...
extern double countATGC( char *s );
...
extern void WriteFloatHat2_pointer( FILE *hat2p, int locnjob, char **name, float **mtx );
