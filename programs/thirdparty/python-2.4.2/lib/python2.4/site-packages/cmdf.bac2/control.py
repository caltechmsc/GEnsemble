...
class Control:
    ...
    def setParameters(self, system):
        ...
        try:
            cmdfKeyFileName = util.searchFileName('cmdf.key')
    ...
    def createObjects(self):
        ...
        if self.miniStr == 'Conjugate Gradient (Shanno-Phua)':
            ...
            if self.printLevel > 0 and self.printLevel < 2: # Print final energy, coordinates, number of func and iter, warning flag.
                ...
                disp = 1
                retall = 1
            self.minimizer = Simplex(self.molName, self.xthreshold, self.fthreshold, self.threshold, self.maxiteration, self.maxfunction, full_output, disp, retall, self.coords)
            ...
            if self.printLevel > 0 and self.printLevel < 2: # Print final energy, coordinates, number of func and iter, warning flag.
                ...
                disp = 1
                retall = 1
            self.minimizer = Powell(self.molName, self.xthreshold, self.fthreshold, self.threshold, self.maxiteration, self.maxfunction, full_output, disp, retall, self.coords)
            ...
            if self.printLevel > 0 and self.printLevel < 2: # Print final energy, coordinates, number of func and iter, warning flag.
                ...
                disp = 1
                retall = 1
            self.minimizer = ConjugateGradient_PR(self.molName, self.xthreshold, self.fthreshold, self.threshold, self.maxiteration, self.maxfunction, full_output, disp, retall, self.coords)
            ...
            if self.printLevel > 0 and self.printLevel < 2: # Print final energy, coordinates, number of func and iter, warning flag.
                ...
                disp = 1
                retall = 1
            self.minimizer = BFGS(self.molName, self.xthreshold, self.fthreshold, self.threshold, self.maxiteration, self.maxfunction, full_output, disp, retall, self.coords)
            ...
            if self.printLevel > 0 and self.printLevel < 2: # Print final energy, coordinates, number of func and iter, warning flag.
                ...
                disp = 1
                retall = 1
            self.minimizer = Newton_CG(self.molName, self.xthreshold, self.fthreshold, self.threshold, self.maxiteration, self.maxfunction, full_output, disp, retall, self.coords)
        else: 
            self.minimizer = None 
