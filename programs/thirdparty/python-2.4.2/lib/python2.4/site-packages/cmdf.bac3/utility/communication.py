...
#
#  Created on 05/05/2006; last revision on 06/27/2006.  Jef and yi
#
########################################################################################
import numpy 
#from cmdf.modbabel import *
...
def systemToArrays(system):
    ...
    itranlist = numpy.zeros(6*natoms, numpy.Int)
    itranlist[:] = 222
    ...
    for i in range(natoms):
        ...
        for j in range(numNeighbors):
            ...
            if j < 6:
                ...
                itranlist[i6+j] = bond.getItran()

    return (cellDim, elements, coords, vels, energy, forces, oldForces, imove, fixed, charges, masses, fftypes, bondlist, orderlist, itranlist)
