...
# 2-D plotting tool
#
# $Id: multiplot.tcl,v 1.25 2006/10/10 17:10:10 saam Exp $
#
# Author:
# Jan Saam
...
# 	    }
	 ...
	 init_dataset
      ...
      proc plot_update {} {
	 variable datasets
	 if {![llength [array get datasets X]]} { variable replot 0; return }
	 if {![llength [array get datasets Y]]} { variable replot 0; return }
