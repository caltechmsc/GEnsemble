...
namespace eval MultiSeq::Import {
    ...
    proc but_browsefile {} {
        ...
        set filenames [tk_getOpenFile -multiple 1 -filetypes {{{FASTA Files} {.fasta}} {{PDB Files} {.pdb}} {{ALN Files} {.aln}} {{NEX Files} {.nex}} {{All Files} * }} -title "Import Sequences/Structures"]
        if {$filenames != {}} {
