...
#                                                                   #
# Copyright (c) 2008                                                #
# Jennelle Bray, Ravinder Abrol and William A. Goddard III          #
...
21 April 2008 Jenelle Bray (jenelle@wag.caltech.edu)
...
open (OUT2,">$outx2");
$outx3 = $prefix . ".bihelix_${geten}_NoAllVDW.out";
open (OUT3,">$outx3");
...
print OUT5 "                    Structure         TotalE     NoInterHelVDW     NoAllVDW        InterHB\n";
