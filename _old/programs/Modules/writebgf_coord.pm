...
package Modules::writebgf_coord;
...
our @EXPORT = qw(writebgf_coord);

# define the function writebgf_coord()

sub writebgf_coord {

    my ($inputbgf,$outputbgf,$allatom_x_ref,$allatom_y_ref,$allatom_z_ref) = @_;
