...
def main():
    ...
    scream_delta_file = '/project/Biogroup/Software/GEnsemble/programs/scream2/lib/SCREAM_delta_par_files/SCREAM_delta_Total_Min.par'
    ff_file = os.environ.get('FORCE_FIELD_FILE')
    eachAtomDelta_file = '/project/Biogroup/Software/GEnsemble/programs/scream2/lib/SCREAM_delta_par_files/SCREAM_EachAtomDeltaFileStub.par'
    polarExclusion_file = '/project/Biogroup/Software/GEnsemble/programs/scream2/lib/SCREAM_delta_par_files/SCREAM_PolarOptimizationExclusionsStub.par'
