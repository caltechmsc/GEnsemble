...
foreach $totinline (@totin)
{
  ...
  if ($i >= $num_str1 && $i <= $num_str2)  
  {
    ...
    $nonmin = $tag . "." . $thtx[1] . "_" . $thtx[2] . "_" . $thtx[3] . "_" . $thtx[4] . "_" . $thtx[5] . "_" . $thtx[6] . "_" . $thtx[7] . "x" . $phix[1] . "_" . $phix[2] . "_" . $phix[3] . "_" . $phix[4] . "_" . $phix[5] . "_" . $phix[6] . "_" . $phix[7] . "x" . $etax[1] . "_" . $etax[2] . "_" . $etax[3] . "_" . $etax[4] . "_" . $etax[5] . "_" . $etax[6] . "_" . $etax[7] . "x" . $hpmx[1] . "_" . $hpmx[2] . "_" . $hpmx[3] . "_" . $hpmx[4] . "_" . $hpmx[5] . "_" . $hpmx[6] . "_" . $hpmx[7] . ".bgf";
    system ("/project/Biogroup/Software/GEnsemble/programs/superbihelix/make-bgf-for-combi.pl $bgf $mfta \"$totinline\"");
    system ("cp $bundle $nonmin");
