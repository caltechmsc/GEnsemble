...
for ($i = 0; $i < 12; $i++)
{
  ...
  print PBS "/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_bihelix_anal/super_bihelix_anal.pl $tm1[$i] $tm2[$i] $nm $lst $numba > \$SCRATCH/\${PBS_JOBNAME}.output\n\n";
