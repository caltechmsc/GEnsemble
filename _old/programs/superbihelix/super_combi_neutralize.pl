...
if ($fin == 1)
{
  ...
  system("/project/Biogroup/Software/GEnsemble/programs/superbihelix/super_neutral_sort.pl -p $proc -b $bgf -m $mfta --sortrank 'CNi'  --range  '1-25' --ppn 1 --bio $bio -md $masterdir");
}
