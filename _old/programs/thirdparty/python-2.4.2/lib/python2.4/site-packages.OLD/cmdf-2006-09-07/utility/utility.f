...
100     continue 
      ...
      subroutine calcinertia(n, mass, r, inert)  
        implicit none
        integer n, i, i31, i32, i33
        real mass(n), r(3*n), rcm(3), inert(3,3)
        real totMass
        real mxx, myy, mzz, mxy, myz, mzx
        real xrel, yrel, zrel
cf2py   integer intent (hide), depend(mass) :: n = len(mass)
cf2py   intent (in) mass, r
...
200     continue
      ...
      subroutine calcangularmomentum(n, mass, r, v, angm)
        implicit none
        integer n, i, i31, i32, i33
        real mass(n), r(3*n), v(3*n), angm(3) 
        real rcm(3), vcm(3)
        real totMass
cf2py   integer intent (hide), depend(mass) :: n = len(mass)
...
c Translate system coordinates(r) to ref.
        implicit none
        integer n, i, i31, i32, i33
        real mass(n), r(3*n), ref(3)
        real cmx, cmy, cmz, totMass 
