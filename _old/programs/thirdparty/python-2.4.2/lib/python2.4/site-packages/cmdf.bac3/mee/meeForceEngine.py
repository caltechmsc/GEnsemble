...
#import cmdf.mee.edrang as edrang
...
class MeeForceEngine:
    ...
    def calcEnergyForceBond(self, coords):
        ...
        energyBond = mee.cmdf_mee_calc_energy_force_bond() * unit.kcalpermol
        ...
        forcesBond = forces * unit.kcalpermol

        return energyBond, forcesBond

    def calcEnergyForceBond2(self, coords):
        numAtoms = self.natoms
        x = numpy.zeros(numAtoms, numpy.Float64)
        y = numpy.zeros(numAtoms, numpy.Float64)
        z = numpy.zeros(numAtoms, numpy.Float64)
        forcesBond2 = numpy.zeros(3 * numAtoms, numpy.Float64)
        ...
        nsecd = True
        energyBond2, forcesBond2X, forcesBond2Y, forcesBond2Z =  \
        mee.edrbnd(x, y, z, nsecd)

        # Set forces.
        for i in range(numAtoms):
            i3 = 3 * i
            forcesBond2[i3]   = forcesBond2X[i]
            forcesBond2[i3+1] = forcesBond2Y[i]
            forcesBond2[i3+2] = forcesBond2Z[i]

        return energyBond2, forcesBond2

    def calcEnergyForceAng(self, coords):
        ...
        energyAng = mee.cmdf_mee_calc_energy_force_ang() * unit.kcalpermol
        ...
        forcesAng = forces * unit.kcalpermol

        return energyAng, forcesAng 

    """
    def calcEnergyForceAng2(self, coords):
        numAtoms = self.natoms
        x = numpy.zeros(numAtoms, numpy.Float64)
        y = numpy.zeros(numAtoms, numpy.Float64)
        z = numpy.zeros(numAtoms, numpy.Float64)
        forcesAng2 = numpy.zeros(3 * numAtoms, numpy.Float64)
        ...
        energyAng2, forcesAng2X, forcesAng2Y, forcesAng2Z =  \
        mee.edrang(x, y, z)

        # Set forces.
        for i in range(numAtoms):
            i3 = 3 * i
            forcesAng2[i3]   = forcesAng2X[i]
            forcesAng2[i3+1] = forcesAng2Y[i]
            forcesAng2[i3+2] = forcesAng2Z[i]

        return energyAng2, forcesAng2
    """

    def calcEnergyForceInv(self, coords):
        ...
        energyInv = mee.cmdf_mee_calc_energy_force_inv() * unit.kcalpermol
        ...
        forcesInv = forces * unit.kcalpermol

        return energyInv, forcesInv 

    def calcEnergyForceTor(self, coords):
        ...
        energyTor = mee.cmdf_mee_calc_energy_force_tor() * unit.kcalpermol
        ...
        forcesTor = forces * unit.kcalpermol

        return energyTor, forcesTor 

    def calcEnergyForceNBall(self, coords):
        ...
        mee.cmdf_mee_calc_energy_force_nball()

        energyVdw = mee.cmdf_mee_get_e_vdw() * unit.kcalpermol
        energyCoulomb = mee.cmdf_mee_get_e_coulomb() * unit.kcalpermol
        ...
        forcesNB = forces * unit.kcalpermol

        return energyVdw, energyCoulomb, forcesNB 

    def calcEnergyForceHBall(self, coords):
        ...
        energyHB = mee.cmdf_mee_calc_energy_force_hball() * unit.kcalpermol
        ...
        forcesHB = forces * unit.kcalpermol

        return energyHB, forcesHB 
