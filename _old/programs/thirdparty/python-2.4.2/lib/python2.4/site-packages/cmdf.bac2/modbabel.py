...
class System(_object):
    ...
    def isPeriodic(*args): return _modbabel.System_isPeriodic(*args)
    def getSgName(*args): return _modbabel.System_getSgName(*args)
    def getAxes(*args): return _modbabel.System_getAxes(*args)
