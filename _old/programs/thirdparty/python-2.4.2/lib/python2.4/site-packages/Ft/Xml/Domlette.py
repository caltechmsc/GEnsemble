########################################################################
# $Header: /var/local/cvsroot/4Suite/Ft/Xml/Domlette.py,v 1.51 2005/11/15 02:22:39 jkloth Exp $
"""
...
__all__ = ['implementation', 'NonvalParse', 'ValParse',
           # utility functions
           'Print', 'PrettyPrint', 'GetAllNs', 'SeekNss', 'ConvertDocument',
...
from cDomlette import implementation, NonvalParse, ValParse, ParseFragment
