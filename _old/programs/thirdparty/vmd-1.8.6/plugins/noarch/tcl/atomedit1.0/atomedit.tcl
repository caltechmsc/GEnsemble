...
# features in a list.
#
# $Id: atomedit.tcl,v 1.13 2006/04/02 21:22:21 saam Exp $
#
...
proc ::Atomedit::atomedit_gui { window listvar atompropformtags selectcallback submitcallback \
   ...
   frame $v.cart.list
   label $v.cart.list.format -font {tkFixed 9} -textvariable $atompropformtags -relief flat -bd 2 -justify left;
   #listbox $v.cart.list.format -font {tkFixed 9}  -relief flat -bd 2 -height 1 -width 0 
   ...
   listbox $v.cart.list.list -selectbackground $selectcolor -height 6 -width 0 \
      -yscroll "$v.cart.list.yscroll set" -font {tkFixed 9} -selectmode extended \
   ...
   if {[llength $copychargetypes]} {
      ...
      label  $v.cart.copy.charges -text "Charges " -font {tkFixed 9}
	 ...
	 -command $copychargecallback
      ...
      $v.cart.copy.type configure -font {tkFixed 9}
