...
namespace eval ::MultiSeq::Phylotree {
    ...
    proc showOptionsDialog {parent} {
        ...
        grid $w.center.l1               -column 1 -row 3 -sticky nw -columnspan 3
        grid $w.center.qh               -column 2 -row 4 -sticky nw -columnspan 2
        grid $w.center.rmsd             -column 2 -row 5 -sticky nw -columnspan 2
        grid $w.center.pid              -column 2 -row 6 -sticky nw -columnspan 2
        grid $w.center.clustalw         -column 2 -row 7 -sticky nw -columnspan 2
        grid $w.center.file             -column 2 -row 8 -sticky nw -columnspan 2
        grid $w.center.filename         -column 2 -row 9 -sticky w -padx 25
        grid $w.center.filebrowse       -column 3 -row 9 -sticky w
