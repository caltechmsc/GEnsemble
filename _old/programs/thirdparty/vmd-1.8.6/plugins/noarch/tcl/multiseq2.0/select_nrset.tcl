...
namespace eval ::MultiSeq::SelectNRSet {
    ...
    proc showSelectNRSetDialog {parent} {
        ...
        variable choices
        set finished 0
        array set initialized {"qhcutoff" 0 "pidcutoff" 0}
        ...
        frame $w.center
            ...
            label $w.center.idcutofflabel -text "Identity Cutoff:"
        ...
        grid $w.center.gapscalelabel    -column 2 -row 6 -sticky w
        grid $w.center.gapscale         -column 3 -row 6 -sticky w
        grid $w.center.seed             -column 1 -row 7 -sticky w -pady 8 -columnspan 3
