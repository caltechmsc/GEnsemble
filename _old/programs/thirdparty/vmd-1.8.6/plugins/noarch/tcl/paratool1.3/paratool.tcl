...
# Paratool plugin
#
# $Id: paratool.tcl,v 1.101 2007/04/05 18:09:42 johns Exp $
#
...
namespace eval ::Paratool:: {
   ...
   namespace import ::QMtool::vmd_clear_bondlist; # qmtool_aux.tcl
...
#      variable havelewis           0
      ...
      variable matchingtypes 1;       # Show only params for matching types when choosing analog params?
