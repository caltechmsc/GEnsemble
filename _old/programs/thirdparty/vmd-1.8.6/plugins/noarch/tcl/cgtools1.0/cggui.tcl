...
##         vmd@ks.uiuc.edu
##
## $Id: cggui.tcl,v 1.25 2007/04/06 18:26:54 kvandivo Exp $
##
...
package require cgnetworking 0.2
package require autopsf
package require solvate

# package require autocgionize
...
#  $w.menubar.help.menu add command -label "Back" \
#        -command {
#           if { $::cggui::menuChoice > 0 } {
        ...
        -command {
           if { $::cggui::menuChoice > 0 } {   
              ...
              if { $::cggui::menuChoice == 1 } {   
                 ...
                 wm title $::cggui::w "CG Reconstruction"
              }
           }   
        }] \
...
## ---------------------- START from CG rep FRAME ---------------------------
  ...
  #puts "before intro text"
  # intro text
  grid [label $fromCGFrame.introText -text "All-Atom Reconstructor"] \
     -row $row -column 0 -columnspan 2 -sticky w
  incr row
...
#  pack $fromCGFrame.anneal.prepInput -side right -fill x -expand 1
  ...
  grid [button $fromCGFrame.applyDB -text "Reconstruct All-Atom Model" \
...
after loading a PSF file." \
      ...
      ::cgnetworking::networkCGMolecule ::cggui::addStatusLine \
          ...
          $::cggui::toCGshapeBondCutoff  $massValue
      ...
      ::cgnetworking::networkCGEDM ::cggui::addStatusLine \
          ...
          $::cggui::toCGshapeEpsInit $::cggui::toCGshapeEpsFinal \
          $::cggui::toCGshapeLambdaInit $::cggui::toCGshapeLambdaFinal \
          $::cggui::toCGshapeBondCutoff $::cggui::toCGshapeFracCutoff \
          $massValue
   }
