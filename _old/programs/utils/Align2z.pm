...
my ($num_bbatoms,$bbatom_x_ref,$bbatom_y_ref,$bbatom_z_ref,$helixid,$nter,$zout,$eigx,$eigy,$eigz,$helz0x,$helz0y) = @_;
...
return (\@bbatom_x,\@bbatom_y,\@bbatom_z);
